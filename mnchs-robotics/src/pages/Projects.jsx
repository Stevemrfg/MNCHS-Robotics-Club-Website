...
const PROJECTS = [
  {
    id: 'PRJ-01',
    name: 'Line Follower Mk.II',
    category: 'Autonomous',
    status: 'In Progress',
    team: 'Build Team A',
    desc: 'An improved line-following robot with PID control and sharper sensor calibration for tighter turns.',
    progress: 70,
  },
  {
    id: 'PRJ-02',
    ...
    desc: 'A 3-DOF servo-driven arm designed for pick-and-place demonstrations at school exhibits.',
    progress: 20,
  },
  {
    id: 'PRJ-03',
    ...
    status: 'Completed',
    team: 'Build Team B',
    desc: 'A wall-following maze solver built for the regional robotics meet.',
    progress: 100,
  },
]
